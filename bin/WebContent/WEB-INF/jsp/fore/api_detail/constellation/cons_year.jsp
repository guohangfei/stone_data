...
<div class="top"><strong>处女座</strong>
...
<a href="${basePath }/fore/api_detail/consYear.do?conNum=${conMain.orderNum }" class="on">今年运势</a>
...
<dt><span><img src="${basePath }/fore_source/image/constell/${conMain.orderNum }.png"  alt="${conMain.conName  }"></span></dt>
	...
	<dd><h4>${conMain.conName  }2017年运势</h4>

	<ul>
	<li><label>整体运势：</label>
	<c:forEach var="i" begin="1" end="${conYear.zhengti }" step="1">   
			<img src="${basePath }/fore_source/image/constell/star.gif" />     
		</c:forEach>
	</li>
	<li><label>爱情运势：</label>
	<c:forEach var="i" begin="1" end="${conYear.aiqing}" step="1">   
			<img src="${basePath }/fore_source/image/constell/star.gif" />     
		</c:forEach>
	</li>
	<li><label>事业学业：</label>
	<c:forEach var="i" begin="1" end="${conYear.shiye }" step="1">   
			<img src="${basePath }/fore_source/image/constell/star.gif" />     
		</c:forEach>
	</li>
	<li><label>财富运势：</label>
	<c:forEach var="i" begin="1" end="${conYear.caifu }" step="1">   
			<img src="${basePath }/fore_source/image/constell/star.gif" />     
		</c:forEach>
	</li>
	<li class="desc"><label>短评：</label>${conYear.duanping }</li></ul></dd>
...
<p><strong class="p1">整体运势</strong><span>${conYear.zhengtib }</span></p>
<p><strong class="p2">爱情运势</strong><span>${conYear.aiqingb }</span></p>
<p><strong class="p3">事业学业</strong><span>${conYear.shiyeb }</span></p>
<p><strong class="p4">财富运势</strong><span>${conYear.caifub }</span></p>
<p><strong class="p5">健康运势</strong><span>${conYear.jiankangb }</span></p><div class="z"></div></div>
