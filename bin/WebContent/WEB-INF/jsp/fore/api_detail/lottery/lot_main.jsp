...
<link type="text/css"
	...
	rel="stylesheet">
<script src="<%=request.getContextPath()%>/fore_source/js/jquery.min.js"></script>
<script
...
<body>
			...
			<div class="wrap">
				<div class="row"
					...
					<div class="input-group col-md-4 col-md-offset-4">
						<form action="${basePath }/fore/lottery.do" method="post"
							onsubmit="return getlotDate()">
							<input id="demo" type="text" class="form-control"
								placeholder="请选择当年日期，以便于查看" readonly
								aria-describedby="icon-datepicker" name="lotDate"
								style="width: 300px;" /> &nbsp;
							<button type="submit"
	...
	<div style="height:500px;background-image: url(${basePath }/fore_source/image/timg.jpg);">

		<div
			style="padding-top: 20px; padding-left: 500px; font-size: 35px; color: #ff3300; position: relative; font-weight: 600;">彩票>>河北快三
		</div>
		<div style="width: 1300px; height: 47px;">
			<table style="text-align: center; width: 1200px" border="0">
				<tr style="left: 300px; font-size: 24px;">  
					<td width="34%">开奖期号</td>  
					<td width="33%">开奖时间</td>
					<td width="33%">开奖号码</td>
				</tr>
		...
		<div style="width: 1300px; overflow: scroll; height: 400px;">
			<table style="text-align: center; width: 1200px" border="0">
				<c:forEach items="${lst }" var="ls">
					<tr style="left: 300px; font-size: 16px;">
						<td width="34%">${ls.lottery_numb}</td>
						<td width="33%">${ls.run_time}</td>
						<td width="33%">${ls.run_numb }</td>
					</tr>
				</c:forEach>
			</table>
		</div>
